...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://localhost/quickshop'); // Replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'quick613a7e71030ad');
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', 'quick613a7e71030ad@ssl');
}
