            ...
            <div class="col-md-4 order-md-2 mb-4">
                ...
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item d-flex justify-content-between">
                        <span>Total (BDT)</span>
                        <strong><?php echo htmlentities($_SESSION['tp']);?> TK</strong>
                    </li>
                </ul>
            </div>
                ...
                <form method="POST" class="needs-validation" novalidate>
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="customer_name" class="form-control" id="customer_name"
                                placeholder="" value="<?php echo $row['name'];?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="customer_mobile" class="form-control" id="mobile"
                                placeholder="Mobile" value="<?php echo $row['contactno'];?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="customer_email" class="form-control" id="email"
                            placeholder="you@example.com" value="<?php echo $row['email'];?>" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="address" placeholder="1234 Main St"
                            value="<?php echo $row['billingAddress']." ".$row['billingState']." ".$row['billingCity']." ".$row['billingPincode'];?>"
                            required>
                        <div class="invalid-feedback">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <input type="hidden" value="<?php echo htmlentities($_SESSION['tp']);?>" name="amount"
