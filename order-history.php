...
?>
				<tr>
					...
					<td class="cart-product-name-info">
						<h6 class='cart-product-description'><a class="product_name" href="product-details.php?pid=<?php echo $row['opid'];?>">
					...
					<td  >
 <a href="javascript:void(0);" class="track" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
					Track</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
