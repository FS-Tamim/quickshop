	...
	{   
		  ...
		  <span aria-hidden="true">&times;</span>
			...
			if(isset($name) && isset($contactno)){
				...
				$query=mysqli_query($con,"update sellers set contactno='$contactno' where id='".$_SESSION['seid']."'");
                $query=mysqli_query($con,"update sellers set contactno='$contactno' where id='".$_SESSION['seid']."'");
				if($query)
				{
                                        ...
                                        <div class="col-md-12 col-sm-12">
                                            ...
                                            <form class="register-form" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        class="form-control unicase-form-control text-input" value="<?php echo $_SESSION['shopname'];
