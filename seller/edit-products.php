...
<?php echo htmlentities($row['productDescription']);?>
                                    ...
                                    <input type="hidden" value="<?php echo htmlentities($row['merchant']);?>"
